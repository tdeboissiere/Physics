...
def plot_limit(bolo_name, list_mass, analysis_type, exposure, detector_mass = 0.6):
	...
	t_CB = TText(0.3,1E-10,"truc")
	t_CB.SetTextSize(0.06)
	t_CB.SetTextColor(kRed)
	t_CB.DrawText(13,1.5E-3,"PRELIMINARY")

	raw_input()

	cc.Print("./Figures/FID837_" + analysis_type + "_forMoriond_limit.png")
