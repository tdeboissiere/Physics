...
def plot_limit(bolo_name, list_mass, analysis_type, exposure, detector_mass = 0.6):
	...
	gr_xenon100 = get_limit_graph("./Text_files/Published_limits/xenon100.txt", 3, kRed-5)
	...
	gr_cresst = get_limit_graph("./Text_files/Published_limits/cresst2014.txt", 3, kGreen+2)
	gr_pico = get_limit_graph("./Text_files/Published_limits/pico2015.txt", 2, kCyan-7)

	h = TH1F("h", "", 100, 1,25)
	PyRPl.process_TH1(h, X_title = "Mass (GeV)", Y_title = "#sigma (pb)", X_title_size = .06, Y_title_size = .06, X_title_offset = .98, Y_title_offset = 1.06)
	...
	t_cdms.SetTextSize(0.04)
	t_cdms.SetTextColor(kBlue-3)
	t_cdms.DrawText(3.37,1.35E-5,"CDMS")

	t_dama = TText(0.3,1E-10,"truc")
	t_dama.SetTextSize(0.04)
	t_dama.SetTextColor(kRed-3)
	t_dama.DrawText(9.7,1.2E-4,"DAMA")

	t_cresst = TText(0.3,1E-10,"truc")
	t_cresst.SetTextSize(0.04)
	t_cresst.SetTextColor(kGreen+2)
	t_cresst.DrawText(1.15,2.0E-3,"CRESST")


	t_CoGeNT = TText(0.3,1E-10,"truc")
	t_CoGeNT.SetTextSize(0.04)
	t_CoGeNT.SetTextColor(kOrange+7)
	t_CoGeNT.DrawText(14.5,1.07E-5,"CoGeNT")

	t_lux = TText(0.3,1E-10,"truc")
	t_lux.SetTextSize(0.04)
	t_lux.SetTextColor(kBlack)
	t_lux.DrawText(5.42,6E-8,"LUX")

	t_lux = TText(0.3,1E-10,"truc")
	t_lux.SetTextSize(0.04)
	t_lux.SetTextColor(kBlack)
	t_lux.DrawText(2,1E-9,"Neutrinos")

	t_xenon = TText(0.3,1E-10,"truc")
	t_xenon.SetTextSize(0.04)
	t_xenon.SetTextColor(kRed-5)
	t_xenon.DrawText(13.7,4.4E-8,"XENON100")

	t_edw2 = TText(0.3,1E-10,"truc")
	t_edw2.SetTextSize(0.04)
	t_edw2.SetTextColor(kRed)
	t_edw2.DrawText(6.6,1.1E-3,"EDW-II")

	t_edw3 = TText(0.3,1E-10,"truc")
	t_edw3.SetTextSize(0.04)
	t_edw3.SetTextColor(kRed)
	t_edw3.DrawText(3.7,2.7E-3,"EDW-III")

	raw_input()

	cc.Print("./Figures/FID837_" + analysis_type + "_very_lowmass.eps")
	# cc.Print("./Figures/FID837_" + analysis_type + "_very_lowmass_noEDWIII.eps")
