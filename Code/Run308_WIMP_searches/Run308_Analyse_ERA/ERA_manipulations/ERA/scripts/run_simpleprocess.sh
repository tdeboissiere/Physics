...
# SimpleProcess : copie fichiers traces
...
## Lancement programme
echo "** Etape: SimpleProcess.exe"
${eradir}/bin/SimpleProcess.exe ${paramfile}
echo "** Done."

## Copie fichiers de sortie
cp ${TMPDIR}/AnaDir/${bolo}/Amplitudes/basicntp_${run}_${bolo}.root ${anadir}/${bolo}/Amplitudes/.
