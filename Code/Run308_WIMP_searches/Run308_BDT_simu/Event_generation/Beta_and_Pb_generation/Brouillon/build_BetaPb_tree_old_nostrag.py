...
def build_BetaPb_tree(bolo_name, analysis_type, event_type, d_cut, num_event):
    ...
    if event_type == "S1Beta":
        for i in range(num_event):
            ...
            EIA[0]=func_convS1Beta.Eval(evt_heat) + np.random.normal(0, d_std_true_events["FWIA"])
            EIC[0]=np.random.normal(0, d_std_true_events["FWIC"])

            EIB[0]=func_convS1Beta.Eval(evt_heat) + np.random.normal(0, d_std_true_events["FWIB"])
            ...
            if (BDT_ut.bool_pass_cut(EC, EI, EIA[0], EIC[0], d_cut, d_std_true_events) and np.random.binomial(1,accept)==1):  
    ...
    if event_type == "S2Beta":
        for i in range(num_event):
            ...
            EIC[0]=func_convS2Beta.Eval(evt_heat) + np.random.normal(0, d_std_true_events["FWIC"])

            EIB[0]=np.random.normal(0, d_std_true_events["FWIB"])
            EID[0]=func_convS2Beta.Eval(evt_heat) + np.random.normal(0, d_std_true_events["FWID"])
    ...
    if event_type == "S1Pb":
        for i in range(num_event):
            ...
            EIA[0]=func_convS1Pb.Eval(evt_heat) + np.random.normal(0, d_std_true_events["FWIA"])
            EIC[0]=np.random.normal(0, d_std_true_events["FWIC"])

            EIB[0]=func_convS1Pb.Eval(evt_heat) + np.random.normal(0, d_std_true_events["FWIB"])
            EID[0]=np.random.normal(0, d_std_true_events["FWID"])
    ...
    if event_type == "S2Pb":
        for i in range(num_event):
            ...
            EIA[0]=np.random.normal(0, d_std_true_events["FWIA"])
            EIC[0]=func_convS2Pb.Eval(evt_heat) + np.random.normal(0, d_std_true_events["FWIC"])

            EIB[0]=np.random.normal(0, d_std_true_events["FWIB"])
            EID[0]=func_convS2Pb.Eval(evt_heat) + np.random.normal(0, d_std_true_events["FWID"])
