...
def build_Gamma_tree(bolo_name, event_type, num_event):
    ...
    file_tree = TFile(Ana_path + "Analyse_" + bolo_name + "/ROOT_files/" + bolo_name +  "_" + event_type + "_tree_test.root", "recreate")
    ...
    if event_type == "FidGamma":
        for i in range(num_event):
            ...
            evt_heat = func_FidGamma.GetRandom(1,15)
    ...
    if event_type == "S1Gamma":
        for i in range(num_event):
            ...
            evt_heat = func_S1Gamma.GetRandom(1,15)
    ...
    if event_type == "S2Gamma":
        for i in range(num_event):
            ...
            evt_heat = func_S2Gamma.GetRandom(1,15)
...
bolo_name = "FID837"
list_type = ["FidGamma", "S1Gamma", "S2Gamma"]
list_numevt = [1000, 500, 500]
for index, event_type in enumerate(list_type):
    build_Gamma_tree(bolo_name, event_type, list_numevt[index])