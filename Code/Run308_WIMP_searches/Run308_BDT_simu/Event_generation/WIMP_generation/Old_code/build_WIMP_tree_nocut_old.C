...
int fill_root_tree (int Wmass, int num_events, TString bolo_name, TString analysis_type)
{
    ...
    outfilename=gen_path + TString("BDT_") + bolo_name + TString("/") + analysis_type + TString("/WIMP/ROOT_files/") + bolo_name + TString("_WIMP_mass_")+s_Wmass+TString("_nocut_tree.root");
...
int main()
{
    ...
    // Wmass_vec.push_back(5);    num_events.push_back(8000000);
    // Wmass_vec.push_back(6);    num_events.push_back(1600000);
    // Wmass_vec.push_back(7);    num_events.push_back(800000);
    // Wmass_vec.push_back(8);    num_events.push_back(400000);
    // Wmass_vec.push_back(9);    num_events.push_back(200000);
    // Wmass_vec.push_back(10);    num_events.push_back(60000);
    // Wmass_vec.push_back(15);    num_events.push_back(50000);
    // Wmass_vec.push_back(20);    num_events.push_back(30000);
    // Wmass_vec.push_back(25);    num_events.push_back(20000);
    // Wmass_vec.push_back(30);    num_events.push_back(20000);


    // // Heat cut at 1.5 keV
    // Wmass_vec.push_back(5);    num_events.push_back(15000000);
    // Wmass_vec.push_back(6);    num_events.push_back(900000);
    // Wmass_vec.push_back(7);    num_events.push_back(200000);
    // Wmass_vec.push_back(10);    num_events.push_back(40000);
    // Wmass_vec.push_back(25);    num_events.push_back(10000);
